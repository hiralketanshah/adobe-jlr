...
class ContentBlockContainerImplTest {
...
private ContentBlockContainerModel contentBlockContainerModel;
    ...
    public void setup(AemContext context) {
        context.load().json("/content/jlr/contentblockcontainer/contentblockcontainer.json", "/content/jlr/contentblockcontainer.html");
