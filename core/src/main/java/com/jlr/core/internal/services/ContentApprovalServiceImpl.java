...
public class ContentApprovalServiceImpl implements ContentApprovalService {
    ...
    @Override
    public void processMetadata(String approvalStatus, String activateNowLater, String contentPublishingDate, String embargoLiftDate, Page page, ResourceResolver resourceResolver) {
        if(page.listChildren() != null) {
            while(page.listChildren().hasNext()) {
                Page child = page.listChildren().next();
                if(child != null) {
                    processMetadata(approvalStatus, activateNowLater, contentPublishingDate, embargoLiftDate, child, resourceResolver);
                }
            }
        }
    ...
    private void fetchAssetsOfPage(String approvalStatus, String activateNowLater, String contentPublishingDate, String embargoLiftDate, Page page, ResourceResolver resourceResolver) {
        ...
        if(MapUtils.isNotEmpty(assetMap)) {
            assetMap.entrySet().stream().forEach(entry -> {
                ...
                addProperties(approvalStatus, activateNowLater, contentPublishingDate, embargoLiftDate, page, properties);
            });
        }
    }

    private void addMetadataToPage(String approvalStatus, String activateNowLater, String contentPublishingDate, String embargoLiftDate, Page page) {
        ValueMap properties = page.getProperties();
        addProperties(approvalStatus, activateNowLater, contentPublishingDate, embargoLiftDate, page, properties);
    }

    private void addProperties(String approvalStatus, String activateNowLater, String contentPublishingDate, String embargoLiftDate, Page page, Map<String, Object> properties) {
