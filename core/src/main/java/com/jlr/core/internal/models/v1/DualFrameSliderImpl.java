...
@Model(adaptables = Resource.class, adapters = {
		DualFrameSliderModel.class }, resourceType = DualFrameSliderImpl.RESOURCE_TYPE)
public class DualFrameSliderImpl extends GlobalModelImpl implements DualFrameSliderModel {
    ...
    public void init() {
    	...
    	if(null != folderRes) {
    		...
    		while (childResItr.hasNext()) {
    			...
    			if(!imageName.equals(CommonConstants.JCR_CONTENT) && imageName.contains(CommonConstants.DOT)) {
	...
	/**
	 * Build the Frame path using folder path and Image name
	 * 	 * @param imageName
	 */
