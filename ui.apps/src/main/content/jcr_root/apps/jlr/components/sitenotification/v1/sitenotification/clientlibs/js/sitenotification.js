...
/******/ 			return installedModules[moduleId].exports;
    ...
    /******/ 	return __webpack_require__(__webpack_require__.s = "./src/main/webapp/components/PopupModal/js/PopupModal.js");
  /******/
})
    /************************************************************************/
    /******/({
    ...
    /***/ "./src/main/webapp/components/Modal/es6/Modal.js":
    /*!*******************************************************!*\
      !*** ./src/main/webapp/components/Modal/es6/Modal.js ***!
      \*******************************************************/
    /*! no static exports found */
        ...
        var Modal = function () {
          function Modal(element, options) {
            ...
            this._closeOnEsc = function (event) {
              if (event.keyCode === _aria.KeyCode.ESC) {
          ...
          (0, _createClass3.default)(Modal, [{
            key: '_attachModal',
            value: function _attachModal() {
              var _this2 = this;

              var elem = document.createElement('section');
              var _options = this.options,
                className = _options.className,
                modalModifier = _options.modalModifier,
                closeLabel = _options.closeLabel,
                enableClose = _options.enableClose;

              var headerContent = enableClose ? '<button data-modal-close class="' + className + '__close"></button>' : '';
              var html = '\n          <div class="' + className + '__content-wrapper">\n            <div class="' + className + '__header">\n              ' + headerContent + '\n            </div>\n            <div data-modal-content class="' + className + '__content"></div>\n            <div data-modal-footer class="' + className + '__footer"></div>\n          </div>\n        ';
              ...
              // Handle modifiers
              if (modalModifier !== null) {
                if (!Array.isArray(modalModifier)) {
                  this.options.modalModifier = modalModifier.split();
                }
                this.options.modalModifier.forEach(function (modifier) {
                  return elem.classList.add(className + '--' + modifier);
                });
              }
              ...
              var modalContent = elem.querySelectorAll('[data-modal-content]')[0];
              this._modalContent = modalContent;

              var modalFooter = elem.querySelectorAll('[data-modal-footer]')[0];
              this._modalFooter = modalFooter;

              var bg = document.createElement('div');
              bg.classList.add(className + '__background');
              bg.setAttribute('data-modal-close', '');
              elem.appendChild(bg);

              if (enableClose) {
                [].concat((0, _toConsumableArray3.default)(this._modal.querySelectorAll('[data-modal-close]'))).forEach(function (closer) {
                  if (closeLabel !== null) {
                    closer.setAttribute('aria-label', closeLabel);
                  }
            ...
            key: '_detachModal',
            value: function _detachModal() {
              var modal = document.querySelectorAll(this.options.selector)[0];
              if (!(0, _utils.checkDefined)(modal)) {
                return;
              }
            ...
            value: function _keyboardControls() {
              this._modal.focus(); // Move focus to modal instead of button
              var enableClose = this.options.enableClose;
              // Get list of tabbable elements and lock focus within modal

              var tabbables = (0, _utils.getTabbable)(this._modal);
              (0, _utils.lockTabbables)(tabbables);
              if (enableClose) {
                this._modal.addEventListener('keydown', this._closeOnEsc);
              }
            }
          }, {
            key: '_open',
            value: function _open(el) {
              var _this3 = this;

              Modal.toggleContent(true);
              this._attachModal();
              this._modalContent.innerHTML = '';
              this._modalContent.appendChild(el.cloneNode(true));
              this._modal.style.display = 'block';
              this.element.setAttribute('data-modal-return', 'true');

              var handleModalScroll = function handleModalScroll() {
                if (_this3._modalContent.scrollTop === _this3._modalContent.scrollHeight - _this3._modalContent.offsetHeight) {
                  _this3._modalFooter.style.opacity = 0;
                  requestAnimationFrame(function () {
                    setTimeout(function () {
                      _this3._modalFooter.style.display = 'none';
                      _this3.isHidden = true;
                    }, 10);
                  });
                } else if (_this3._modalContent.scrollTop !== _this3._modalContent.scrollHeight - _this3._modalContent.offsetHeight && _this3.isHidden) {
                  _this3.isHidden = false;
                  _this3._modalFooter.style.display = 'block';
                  requestAnimationFrame(function () {
                    setTimeout(function () {
                      _this3._modalFooter.style.opacity = 1;
                    }, 10);
                  });
                }
              };
              ...
              requestAnimationFrame(function () {
                _this3._modal.style.opacity = 1;

                if (!(0, _utils.isElementVerticallyScrollable)(_this3._modalContent)) {
                  _this3._modalFooter.style.display = 'none';
                } else {
                  _this3._modalContent.addEventListener('scroll', handleModalScroll);
                }

                (0, _utils.dxSetTimeout)(function () {
                  _this3._keyboardControls();
                  _this3._eventTrigger(_this3.options.className + ':opened');
                }, _this3.options.speed);
              });
            }
          }, {
            key: '_close',
            value: function _close() {
              ...
              Modal.toggleContent(false);

              // ontransitionend was unreliable with focusing the previous element and was causing other functionality to break with JS errors
              // Below is the same implementation in jQuery version of component
              requestAnimationFrame(function () {
                _this4._modal.style.opacity = 0;
                setTimeout(function () {
                  _this4._modal.style.display = 'none';
                  _this4._eventTrigger(_this4.options.className + ':closed');
                  _this4._detachModal();
                  _this4.element.focus();
                  var returnElem = document.querySelectorAll('[data-modal-return]')[0];
                  returnElem.focus();
            ...
            key: '_eventTrigger',
            value: function _eventTrigger(eventType) {
            ...
            key: 'resetKeyboardControls',
            value: function resetKeyboardControls() {
              this._keyboardControls();
            }
          }], [{
            key: 'toggleContent',
            value: function toggleContent(toggle) {
    ...
    /***/ "./src/main/webapp/components/PopupModal/js/PopupModal.js":
    /*!****************************************************************!*\
      !*** ./src/main/webapp/components/PopupModal/js/PopupModal.js ***!
      \****************************************************************/
    /*! no static exports found */
    /***/ (function (module, exports, __webpack_require__) {
        ...
        var _modalDisplay = __webpack_require__(/*! ./classes/modalDisplay */ "./src/main/webapp/components/PopupModal/js/classes/modalDisplay.js");
        ...
        var PopupModal = function () {
          ...
          (0, _createClass3.default)(PopupModal, [{
            ...
            value: function _initialise() {
              this.modalDisplay = new _modalDisplay2.default();
              this.modalDisplay.initialise(this.element);
            }
          }]);
          return PopupModal;
        }(); /* window */
        ...
        var PopupModals = document.querySelectorAll('.cmp-popupModal');
        if (PopupModals.length) {
          Array.prototype.forEach.call(PopupModals, function (el) {
            return new PopupModal(el);
          });
        }
    ...
    /***/ "./src/main/webapp/components/PopupModal/js/classes/modalDisplay.js":
    /*!**************************************************************************!*\
      !*** ./src/main/webapp/components/PopupModal/js/classes/modalDisplay.js ***!
      \**************************************************************************/
    /*! no static exports found */
    /***/ (function (module, exports, __webpack_require__) {
        ...
        var _uiSelectors = __webpack_require__(/*! ./uiSelectors */ "./src/main/webapp/components/PopupModal/js/classes/uiSelectors.js");

        var _cookieManager = __webpack_require__(/*! ../../../../resources/dev/js/utils/cookieManager */ "./src/main/webapp/resources/dev/js/utils/cookieManager.js");

        var _Modal = __webpack_require__(/*! ../../../Modal/es6/Modal */ "./src/main/webapp/components/Modal/es6/Modal.js");
        ...
        var ModalDisplay = function () {
          function ModalDisplay() {
            (0, _classCallCheck3.default)(this, ModalDisplay);
          }

          (0, _createClass3.default)(ModalDisplay, [{
            key: 'initialise',
            ...
            value: function checkModalCookie() {
              var cookieForModal = (0, _cookieManager.readCookie)('JLR_DxPopupShown_' + this.cookieID);
              return cookieForModal;
            }
          }, {
            ...
            value: function generateModalContent() {
              var modalContent = this.element.querySelector(_uiSelectors.uiSelectors.content);
              return modalContent;
            }
          }, {
            key: 'displayModal',
            value: function displayModal(modalContent) {
              var modalTrigger = this.element;
        ...
        exports.default = ModalDisplay;

        /***/
      }),

    /***/ "./src/main/webapp/components/PopupModal/js/classes/uiSelectors.js":
    /*!*************************************************************************!*\
      !*** ./src/main/webapp/components/PopupModal/js/classes/uiSelectors.js ***!
      \*************************************************************************/
    /*! no static exports found */
    /***/ (function (module, exports) {
        ...
        var uiSelectors = exports.uiSelectors = {
          content: '.cmp-popupModal__body'
        };
