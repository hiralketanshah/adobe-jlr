$("div.carousel.aem-GridColumn").each(function (index, value) {
  ...
  if ($(value).find(".swiper-slide-active .dualframecarousel").first().hasClass("right")) {
  ...
  } else if (!$(value).find(".swiper-slide-active .dualframecarousel").first().hasClass("right") || $(value).find(".dualframecarousel").first().hasClass("left")) {
