...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var OffersContainer = function () {
    function OffersContainer(element) {
      ...
      this.offerDescription = this.element.querySelector('.offerDescription');
      this.offerLinkClone = $(element).find(".offerLink").clone();
      this.offerLinkClone.appendTo(this.offerDescription);
      this.offerDescription = this.element.querySelector('.offerDescription');
      this.offerLinkResponsive = $(element).find('.offerLinkResponsive');
      // $(window).resize(()=>{
      //   if(window.screen.width>=768 && window.screen.width<=1279){
      //     this.offerLinkResponsive.removeClass("hide");
      //    }
      //    else{
      //     this.offerLinkResponsive.addClass("show");
      //    }
      // });
      
   
      if(this.ul){
          this.ul.classList.add("bullets","bullets--line");
      }
