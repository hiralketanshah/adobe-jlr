                ...
                var DxTabs = function () {
                    ...
                    (0, _createClass3.default)(DxTabs, [{
                        ...
                        value: function tabClickHandler(event) {
                            ...
                            if (((this.tabs.length) - 1) == $(active).attr('data-tab-index')) {
                                this.tablist.classList.remove('rightShade');
                                this.tablist.classList.add('leftShade');
                            } else {
                                this.tablist.classList.remove('leftShade');
                                this.tablist.classList.add('rightShade');
                            }
                ...
                (function ($, window) {
                    var TabbedContainer = {
                        ...
                        _setUpYouTubeGalleryAssets() {
                            ...
                            $(`#${tabId} .cmp-tabs__tabpanel`).each(function (i, obj) {
                                let pannelId = $(obj).context.id;
                                let videos = $(`#${tabId} #${pannelId} .videoCustom`);

                                videos.each(function (i, obj) {
                                    let imagePresentOrNot = $(obj).find('img').attr('src');
                        ...
                        _initializeSelectedTab: function _initializeSelectedTab(payload) {
                            var _this4 = this;
                            var tabId = $(_this4.$element)[0].id;
                            var panelID = $(payload)[0].selectedPanel.id;
                            ...
                            setTimeout(() => {
                                ...
                                this.$element.parent().animate({ height: `${initialHeight}px` }, 0);/*bugfix-1180*/
                        ...
                        _destroyPreviousTab: function _destroyPreviousTab(payload) {
                            ...
                            var tabId = $(_this4.$element)[0].id;
                            var panelID = $(payload.previousPanel).find('.videoCustom').context.id;
                            ...
                            if (this._selectedTab) {
                                if (isDesktop && !this.destroyed) {
                                    setTimeout(function () {
                                        ...
                                        _this4.$element.parent().css({ height: `${initialHeight}px` ,"min-height":`${initialHeight}px`});/*bugfix-1180*/
