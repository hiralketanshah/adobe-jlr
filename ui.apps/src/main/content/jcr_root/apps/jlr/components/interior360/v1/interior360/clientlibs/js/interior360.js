...
function embedpanoJS(e) {
  eval(function (d) {
    var e = String.fromCharCode, n = 1, k = d.length, b = null, g = null, a = 0, h = 0, m = 0, c = 0, j = 0, l = 0, f = 0; try { e.apply(null, (new Uint8Array(4)).subarray(2)) } catch (p) { n = 0 } g = n ? Uint8Array : Array; for (b = new g(4 * k / 5); a < k;)m = d.charCodeAt(a++) - 35, c = d.charCodeAt(a++) - 35, j = d.charCodeAt(a++) - 35, l = d.charCodeAt(a++) - 35, f = d.charCodeAt(a++) - 35, 56 < m && m-- , 56 < c && c-- , 56 < j && j-- , 56 < l && l-- , 56 < f && f-- , f += 85 * (85 * (85 * (85 * m + c) + j) + l), b[h++] = f >> 24 & 255, b[h++] = f >> 16 & 255, b[h++] = f >> 8 & 255, b[h++] = f & 255; g = new g(b[2] <<
      16 | b[1] << 8 | b[0]); k = 8 + (b[6] << 16 | b[5] << 8 | b[4]); a = 8; for (h = 0; a < k;) { m = b[a++]; c = m >> 4; for (j = c + 240; 255 === j; c += j = b[a++]); for (l = a + c; a < l;)g[h++] = b[a++]; if (a === k) break; f = h - (b[a++] | b[a++] << 8); c = m & 15; for (j = c + 240; 255 === j; c += j = b[a++]); for (l = h + c + 4; h < l;)g[h++] = g[f++] } b.length = 0; k = g.length; d = ""; if (n) for (a = 0; a < k; a += 32E3)d += e.apply(null, g.subarray(a, a + 32E3)); else for (a = 0; a < k; a += 32E3)d += e.apply(null, g.slice(a, a + 32E3)); return d
